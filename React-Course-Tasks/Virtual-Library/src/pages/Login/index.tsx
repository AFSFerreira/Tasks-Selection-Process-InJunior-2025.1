...
export default function Login() {
  ...
  const { register, handleSubmit, reset, formState: { errors, isSubmitting } } = useForm<UserLoginInput>({
    ...
    <>
      <div className={styles['login-info-container']}>
        ...
        <section className={styles['login-section']}>
          ...
          <form onSubmit={handleSubmit(createUser)} className={styles['auth-login-form']}>
            <AuthField
              {...register('email')}
            ...
            <div className={styles['buttons-box']}>
              ...
              >
                {isSubmitting && registerClicked ? "Cadastrando..." : "Cadastrar-se"}
              </button>
